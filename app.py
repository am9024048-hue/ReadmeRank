...
# تعديل الستايل لضمان اتجاه النصوص العربية بشكل صحيح وتجنب مشاكل انعكاس الرموز
st.markdown(
    """
    <style>
    .main {
    ...
    /* تنسيق خاص لأسطر التقارير لضمان ظهور الأيقونات والعربية بشكل طبيعي */
    .report-line {
        direction: rtl;
        text-align: right;
...
if st.button("🚀 ابدأ الفحص الهيكلي الشامل"):
  ...
  if readme_content.strip():
    with st.spinner("⚡ جاري فحص هيكل الملف وتقييم الأقسام..."):
      ...
      st.markdown(
          f'<div class="report-line">📌 قسم التثبيت (Installation):'
          f" {inst_status}</div>",
          unsafe_allow_html=True,
      )
      ...
      st.markdown(
          f'<div class="report-line">💡 قسم الاستخدام والأمثلة (Usage):'
          f" {usage_status}</div>",
          unsafe_allow_html=True,
      )
      ...
      st.markdown(
          f'<div class="report-line">⚖️ شروط الترخيص (License):'
          f" {lic_status}</div>",
          unsafe_allow_html=True,
      )
      ...
      st.markdown(
          f'<div class="report-line">🤝 دليل المساهمة (Contributing):'
          f" {contrib_status}</div>",
          unsafe_allow_html=True,
      )

      badge_status = "توجد شارات ✅" if has_badges else "لا توجد شارات ⚠️"
      st.markdown(
          f'<div class="report-line">🏷️ الشارات (Badges): {badge_status}</div>',
          unsafe_allow_html=True,
      )
